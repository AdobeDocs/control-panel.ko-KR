...
1. 다음에서 **[!UICONTROL 하위 도메인 및 인증서]** 카드를 클릭하고 원하는 인스턴스를 선택한 다음 **[!UICONTROL 인증서 관리]** 단추를 클릭합니다.

   ![](assets/renewal1.png)

1. 선택 **[!UICONTROL 1 - CSR 생성]**&#x200B;을 클릭한 다음 을 클릭합니다 **[!UICONTROL 다음]** csr 생성 프로세스를 안내하는 마법사를 시작합니다.

   ![](assets/renewal2.png)

1. CSR을 생성하는 데 필요한 모든 세부 정보가 포함된 양식이 표시됩니다.

   요청된 정보를 완전하고 정확하게 입력해야 합니다. 이렇게 하지 않으면 인증서가 갱신되지 않을 수도 있습니다. 필요한 경우 내부 보안/IT 팀에 문의하여 정보를 확인하고 입력한 후에 **[!UICONTROL 다음]**.

   * **[!UICONTROL 조직]**: 공식 조직 이름
   * **[!UICONTROL 조직 단위]**: 하위 도메인에 연결된 사업부(예: 마케팅, IT)
   * **[!UICONTROL 인스턴스]** (사전 입력되어 있음): 하위 도메인에 연결된 Campaign 인스턴스의 URL
   * **[!UICONTROL 일반 이름]**: 기본적으로 일반 이름이 선택되어 있으며 필요한 경우 하위 도메인 중 하나를 선택할 수 있습니다.

   ![](assets/renewal3.png)

1. CSR에 포함할 하위 도메인을 선택하고 **[!UICONTROL 확인]**.

   ![](assets/renewal4.png)

1. 선택한 하위 도메인이 목록에 표시됩니다. 각 CSR에 포함할 하위 도메인을 선택하고 **[!UICONTROL 다음]**.

   ![](assets/renewal5.png)

1. CSR에 포함할 하위 도메인의 요약이 표시됩니다. 클릭 **[!UICONTROL 제출]** 을 클릭하여 요청을 확인합니다.

   ![](assets/renewal6.png)

   >[!NOTE]
   >
   >다음 **[!UICONTROL CSR 콘텐츠 복사]** 버튼을 사용하면 CSR과 관련된 모든 정보(조직 ID, 인스턴스, 조직 이름, 일반 이름, 포함된 하위 도메인 등)를 복사할 수 있습니다.
...
1. 다음에서 **[!UICONTROL 작업 로그]**&#x200B;를 선택하고 **[!UICONTROL 완료됨]** 탭을 클릭한 다음 목록을 필터링하여 하위 도메인 관리와 관련된 작업을 표시합니다.

   ![](assets/renewal-download.png)

1. CSR 생성에 해당하는 작업을 연 다음 **[!UICONTROL 다운로드]** .csr 파일을 가져오려면 링크를 클릭하십시오.
...
1. 선택 **[!UICONTROL 3 - 인증서 번들 설치]**&#x200B;을 클릭한 다음 을 클릭합니다 **[!UICONTROL 다음]** 인증서 설치 프로세스를 안내하는 마법사를 시작합니다.

   ![](assets/install1.png)

1. 설치할 인증서가 포함된 .zip 파일을 선택하고 **[!UICONTROL 제출]**.
