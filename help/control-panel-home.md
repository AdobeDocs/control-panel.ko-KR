...
처리량 및 대기 시간 모니터링 기능이 향상되었습니다. [자세히 보기](performance-monitoring/using/thoughputs-latencies.md)

* 이제 인스턴스의 처리량에 기여하는 상위 5개 게재의 ID를 식별할 수 있습니다.
* 이제 Campaign Classic v7/v8 고객이 특정 채널에 대한 지연을 시각화할 수 있습니다.
