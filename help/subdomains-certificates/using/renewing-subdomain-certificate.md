...
1. CSR을 생성하는 데 필요한 모든 세부 정보가 포함된 양식이 표시됩니다.
   ...
   * **[!UICONTROL Common name]**: 기본적으로 공통 이름이 선택되어 있으며, 필요한 경우 하위 도메인 중 하나를 선택할 수 있습니다.
...
1. CSR에 포함할 하위 도메인의 요약이 표시됩니다. **[!UICONTROL Submit]**&#x200B;을 클릭하여 요청을 확인합니다.
   ...
   >[!NOTE]
   >
   >**[!UICONTROL Copy CSR content]** 버튼으로 CSR과 관련된 모든 정보(조직 ID, 인스턴스, 조직 이름, 공통 이름, 포함된 하위 도메인 등)를 복사할 수 있습니다.
...
1. **[!UICONTROL Job Logs]**&#x200B;에서 **[!UICONTROL Finished]** 탭을 선택한 다음 목록을 필터링하여 하위 도메인 관리와 관련된 작업을 표시합니다.
