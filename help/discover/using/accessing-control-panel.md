...
1. [Experience Cloud 홈 페이지](https://experiencecloud.adobe.com/){target="_blank"}(으)로 이동합니다.
...
1. [Adobe Experience Cloud 홈 페이지](https://experiencecloud.adobe.com/){target="_blank"}의 **빠른 액세스** 섹션 또는 오른쪽 상단 메뉴에서 **캠페인**&#x200B;을(를) 선택합니다.
...
>[!NOTE]
>
>제품 내에서 [Campaign Standard](https://experienceleague.adobe.com/docs/campaign-standard/using/campaign-standard-home.html?lang=ko){target="_blank"}에만 액세스할 수 있습니다.
