...
# IP 범위 목록 허용 {#ip-range-allow-listing}
...
* **단일 IP 주소가 아닌 허용 목록** 에 IP 범위를 추가합니다. 허용 목록에 단일 IP 주소를 추가하려면 범위에 단일 IP만 포함됨을 나타내는 &#39;/32&#39;를 추가하십시오.
* **허용 목록**(예: > 265개 IP 주소 포함)에 매우 넓은 범위를 추가하지 마십시오. /0~/23 사이의 CIDR 형식 범위는 컨트롤 패널에서 거부됩니다.
