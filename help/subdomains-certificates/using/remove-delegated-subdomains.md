...
1. 제거할 도메인 위임 옆에 있는 줄임표 버튼을 클릭하고 을 선택합니다 **[!UICONTROL 위임 제거]**.
...
1. 관련 IP 선호도 및 브랜드 구성을 포함하여 하위 도메인이 연결된 인스턴스에 대한 정보를 검토합니다.
   ...
   선택한 인스턴스에 대한 주 도메인의 위임을 제거하는 경우 **[!UICONTROL 대체 도메인]** 목록을 표시합니다.

   클릭 **[!UICONTROL 다음]** 제거 작업을 진행합니다.

   ![](assets/undelegate-subdomain-details.png)

1. CNAME 유형 위임을 제거하거나 주 도메인을 CNAME을 사용하여 위임된 도메인으로 바꾸는 경우 **[!UICONTROL 작업]** dns 레코드를 관리하는 단계가 표시됩니다. [이 섹션에서 자세히 알아보기](#dns)

1. 표시되는 요약을 검토합니다. 제거를 확인하려면 위임을 제거할 도메인의 URL을 입력하고 을 클릭합니다 **[!UICONTROL 제출]**.
...
1. Campaign 컨트롤 패널으로 돌아가서 **[!UICONTROL 다음]** 위임 제거를 계속 진행합니다.

### DNS 레코드 추가

1. DNS 서버로 이동하여 컨트롤 패널의 목록에 있는 레코드를 추가합니다.
1. DNS 추가 효과가 적용될 때까지 기다립니다.
1. Campaign 컨트롤 패널으로 돌아가서 **[!UICONTROL 확인]**.
1. 레코드 추가가 성공적으로 확인되면 다음을 클릭합니다. **[!UICONTROL 다음]** 위임 제거를 계속 진행합니다.
